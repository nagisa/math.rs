...
//
// We will use order 13 Taylor series for the sine – this gives us about 6-7 digits of precision:
//
...
pub fn _sin(i: f64) -> f64 {
    ...
    //
    // _sin function will deal with calculating sine in aforementioned range.
    let i2 = i * i;
    let i4 = i2 * i2;
    let i6 = i4 * i2;
    let i10 = i6 * i4;
