...
pub const FP_ILOGB0 : c95::c_int = -0x8000_0000;
/// Target and library dependent constant (i.e. might not be compatible with math.h).
pub const FP_ILOGBNAN : c95::c_int = 0x7FFF_FFFF;

/// Get exponent of of a 32-bit floating-point value as an int.
#[no_mangle]
pub extern fn ilogbf(i: f32) -> c95::c_int {
    ...
    if bits == 0 {
        ...
        return exp as c95::c_int;
    } else if bits < 0x7F80_0000 {
        return ((bits >> 23) as c95::c_int) - 0x7F;
    }
    FP_ILOGBNAN
}
...
#[no_mangle]
pub extern fn ilogb(i: f64) -> c95::c_int {
    let mut bits = i.as_bits();
    bits &= !F64_SIGN_MASK;
    if bits == 0 {
        return FP_ILOGB0;
        ...
        return ((bits >> 52) as c95::c_int) - 0x3FF;
    }
    FP_ILOGBNAN
}
